...
class Settings {
    // website secondey.com
    public static let HOST = "www.secondey.com" /// if url has "www" then add host like "www.domain.com" else would be white screen
    
    public static let URL = "https://www.secondey.com/"
